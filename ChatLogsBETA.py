...
try:
    ...
    limite = int(input("Informe o numero de mensagem que vai ficar dentro do range do script em cada canal(Recomendado 50):"))
...
try:
    while True:
        if not canais or not token or not limite or not limite or limite < 5 or not tempo:
